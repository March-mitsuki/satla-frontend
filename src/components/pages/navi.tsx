  ...
  return (
    <div class="flex justify-between">
      <div class="flex gap-5 items-center">
        ...
        <Link href={`/stream/${props.currentProject}`} class="flex items-center gap-1 px-2 py-1 rounded-md hover:bg-neutral-600 ">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div class="h-6 w-[2px] bg-gray-400 rounded-full"></div>
        <Link href={`/translate/${props.currentProject}`} class="flex items-center gap-1 px-2 py-1 rounded-md hover:bg-neutral-600 ">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div class="h-6 w-[2px] bg-gray-400 rounded-full"></div>
        <Link href={`/send/${props.currentProject}`} class="flex items-center gap-1 px-2 py-1 rounded-md hover:bg-neutral-600 ">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
